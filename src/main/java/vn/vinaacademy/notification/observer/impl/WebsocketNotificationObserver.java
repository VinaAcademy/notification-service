...
import static vn.vinaacademy.notification.constants.WebSocketConstants.USER_NOTIFICATION_QUEUE;
...
public class WebsocketNotificationObserver implements NotificationObserver {
  ...
  public void onNotificationCreated(NotificationDTO notification) {
    try {
      messagingTemplate.convertAndSendToUser(notification.getUserId(), USER_NOTIFICATION_QUEUE,
          notification);
    } catch (Exception e) {
